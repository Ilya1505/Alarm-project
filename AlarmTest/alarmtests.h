...
private slots:
    ...
    void test_getMinuteToCall_1();// тест на получение времени до звонка будильника 1
    void test_getMinuteToCall_2();// тест на получение времени до звонка будильника 2
